...
class TwitterClient(context: Context) : OAuthBaseClient(
    ...
    companion object {
        ...
        const val REST_URL = "https://api.twitter.com/1.1" // Get Tweet timelines Resource URL

        const val REST_CONSUMER_KEY =
            BuildConfig.CONSUMER_KEY // set inside apikey.properties

        const val REST_CONSUMER_SECRET =
            BuildConfig.CONSUMER_SECRET // set inside apikey.properties
